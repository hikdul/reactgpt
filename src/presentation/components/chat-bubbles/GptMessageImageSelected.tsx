...
export const GptMessageImageSelected = ({imageUrl, alt, onImageSelected}:gptImageMessageprops) => {
  
  const originalref = useRef<HTMLImageElement>()
  ...
  const onMouseMove = (
    ...
    ctx.drawImage(originalref.current!, 0, 0, canvaWidth, canvaHeight);
        ...
        <div className="flex flex-row items-start">
            ...
            <div className="relative ml-3 text-sm bg-black backdrop-opacity-25 pt-3 pb-2 px-4 shadow rounded-xl">
             <canvas
              ...
              />
              <button onClick={resetCanva} className="btn-primary mt-2">seleccionar</button>
             {/*  <ol>
                <li><b>Original: </b>{text}</li>
                <li><b>GPT use: </b>{alt}</li>
              </ol> 
              <img
                src={imageUrl}
                alt={alt}
